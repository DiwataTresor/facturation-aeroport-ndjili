...
import { Modal as Modal_antd, Space, Badge, Tabs ,Spin} from "antd";
      ...
      <div className="bg-white">
        <div>
          <Tabs defaultActiveKey="1">
            <Tabs.TabPane tab="ENTREE-SORTIE VEHICULES" key="1">
                <h2 className="font-bold text-end">
                  <form onSubmit={(e)=>{
                    e.preventDefault();
...
export default Rapportstationnement;
